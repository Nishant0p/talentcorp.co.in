...
const awardsData = [
  {
    ...
    glow: 'rgba(0,107,184,0.15)',
    colorClass: 'text-[#006bb8]',
    titleClass: 'text-slate-900 group-hover:text-[#006bb8]',
    descClass: 'text-slate-500',
    bulletClass: 'text-slate-600 group-hover:text-slate-700',
    checkClass: 'text-[#006bb8]',
    pillClass: 'bg-[#006bb8]/10 border-[#006bb8]/30 text-[#006bb8]',
    titlePillClass: 'bg-[#006bb8] border-[#006bb8] text-white',
    bgGradient: 'from-white to-slate-50/50 group-hover:from-white group-hover:to-[#006bb8]/5',
    borderColor: 'border-slate-200/80 group-hover:border-[#006bb8]/50',
    iconBg: 'bg-[#006bb8]/10 text-[#006bb8]',
    bulletPoints: [
  ...
  },
  {
    ...
    titleClass: 'text-slate-900 group-hover:text-orange-950',
    descClass: 'text-slate-500',
    bulletClass: 'text-slate-600 group-hover:text-slate-700',
    checkClass: 'text-orange-500',
    pillClass: 'bg-orange-50 border-orange-200/60 text-orange-700',
    titlePillClass: 'bg-orange-600 border-orange-600 text-white',
    bgGradient: 'from-white to-slate-50/50 group-hover:from-white group-hover:to-orange-50/10',
    borderColor: 'border-slate-200/80 group-hover:border-orange-300',
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-6">
                    ...
                    <span className={`rounded-md border px-2.5 py-0.5 text-[9px] font-extrabold uppercase tracking-wider transition-all duration-500 ${award.titlePillClass}`}>
                      {award.title}
                    </span>
                  </div>
