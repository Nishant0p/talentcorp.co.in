                                ...
                                {service.links.map((sub) => {
                                  ...
                                  return (
                                    <Link
                                      ...
                                      className={`block rounded-lg px-3 py-1.5 text-sm font-semibold transition-colors hover:bg-[#f3f8ff] hover:text-[#0f2a4d] ${subActive ? 'bg-[#f3f8ff] text-[#0f2a4d] font-bold' : 'text-[#1a4f87]'}`}
                                    >
                                      {sub.label}
                                    </Link>
                                  );
                          ...
                          return (
                            ...
                            >
                              <button
                                ...
                                className="flex w-full items-center justify-between rounded-lg px-3 py-2 text-center hover:bg-[#f3f8ff] text-[#1a4f87] font-semibold transition-all duration-300"
                              >
                                  ...
                                  {link.links.map((sub) => {
                                    ...
                                    return (
                                      <Link
                                        ...
                                        to={sub.href}
                                        onClick={handleNavigation}
                                        className={`block w-full rounded-lg px-3 py-2 text-center text-sm hover:bg-[#f3f8ff] transition-all duration-300 ${subActive ? 'text-[#0f2a4d] font-bold bg-[#f3f8ff]' : 'text-[#1a4f87]'}`}
                                      >
                                        {sub.label}
                                      </Link>
                                    );
