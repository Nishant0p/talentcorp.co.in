...
const employerBenefits = [
	{
		...
		description: 'Build a ready workforce in-house and reduce hiring overhead for supervisory and management-level roles.',
		color: '#2563EB',
	},
	{
		icon: ShieldCheck,
	...
	},
	{
		...
		description: 'Improve management competence and efficiency by training candidates directly on your processes.',
		color: '#F97316',
	},
	{
		icon: Users,
		title: 'Leadership Development',
		description: 'Develop future leaders and supervisors trained in your work culture from day one.',
		color: '#0EA5E9',
	},
	{
		icon: Briefcase,
	...
	},
	{
		...
		description: 'Contribute to constructive education for underprivileged sectors and skilled managerial talent.',
		color: '#8B5CF6',
	},
]

const programmeHighlights = [
	'NSQF Level-6 in Dual Education Model',
...
const employerModelPoints = [
	...
	'Industry can onboard candidates with graduation qualification or higher.',
	'M. Voc model duration is 2 years for training and certification completion.',
]
...
const steps = [
	...
	},
	{
		...
		description: 'Eligible candidates (18 to 40 years, graduate qualification) are screened and mapped to domain.',
		color: '#F97316',
	},
	{
		number: '03',
		...
		description: 'Students complete four semesters with hands-on OJT for real management and supervisory workflows.',
		color: '#22C55E',
	},
	{
		number: '04',
				...
				<div className="grid items-center gap-10 lg:grid-cols-2">
					<div className="space-y-6">
						<div className="inline-flex items-center gap-2 rounded-full border border-[#F97316]/30 bg-[#F97316]/20 px-4 py-2">
							...
							<span className="text-sm font-bold text-[#F97316]">NSQF Level-6 | Dual Education Model</span>
						</div>

						<h1 className="text-3xl font-bold leading-tight text-white sm:text-5xl lg:text-5xl">
							Master in Vocational Studies
							<span className="mt-2 block text-[#2563EB]">(M. Voc)</span>
						...
						<p className="max-w-xl text-base leading-relaxed text-white/80 lg:text-lg">
							M. Voc is a two-year masters in professional domains for graduates who want practical learning over theory. The programme supports meaningful participation in India&apos;s economy through employment, entrepreneurship, and industry-ready skilling at supervisory and management level.
						</p>
						...
						<div className="flex items-center gap-6 border-t border-white/10 pt-4">
							...
							<div className="h-12 w-px bg-white/20" />
							<div className="text-center">
								<p className="text-3xl font-bold text-[#F97316]">Level 6</p>
					...
					<div className="relative rounded-3xl border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:border-white/40 hover:bg-white/20 cursor-pointer group">
						...
						<h3 className="mb-6 text-2xl font-bold text-white transition-colors group-hover:text-[#F97316]">Major M. Voc Disciplines</h3>
		...
		<section className="relative overflow-hidden py-12 sm:py-20 lg:py-28">
			...
			<div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mb-16 text-center">
					...
					<h2 className="mb-4 text-4xl font-bold text-[#0F172A] lg:text-5xl">Why Industry Partners Choose M. Voc</h2>
					<p className="mx-auto max-w-3xl text-lg text-[#64748B]">
						The scheme enables industry partners with robust infrastructure and training facilities to conduct in-house skilling and build industry-ready managerial and supervisory talent.
					</p>
				</div>
				...
				<div className="grid gap-8 rounded-3xl bg-[#0F172A] p-8 lg:grid-cols-2 lg:p-12">
					...
					<div className="relative h-64 overflow-hidden rounded-2xl border border-white/10 bg-white p-8 lg:h-auto">
						...
						<p className="text-center text-sm leading-relaxed text-[#334155]">
							M. Voc aligns practical management skill development with national framework outcomes to create employable and entrepreneurial talent at supervisory level.
						</p>
					</div>
				</div>
			</div>
		...
		<section className="relative overflow-hidden bg-[#F8FAFC] py-12 sm:py-20 lg:py-28">
			...
			<div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mb-16 text-center">
					...
					<h2 className="mb-4 text-4xl font-bold text-[#0F172A] lg:text-5xl">4 Steps to Build Managerial Talent</h2>
					<p className="mx-auto max-w-2xl text-lg text-[#64748B]">A practical model for industries to train, assess, and deploy high-potential candidates for supervisory and management roles.</p>
				</div>
		...
		<section className="relative overflow-hidden py-12 sm:py-20 lg:py-28">
			...
			<div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mb-16 text-center">
					...
					<p className="mx-auto max-w-2xl text-lg text-[#64748B]">Important conditions for participating industries and trainees in the M. Voc model.</p>
				</div>
			...
			<div className="mx-auto w-full max-w-6xl">
				<div className="flex flex-col items-center justify-between gap-10 rounded-3xl bg-gradient-to-r from-[#2d52b4] to-[#4083ff] p-8 shadow-lg md:flex-row md:p-12">
					<div className="flex-1">
						...
						<p className="mb-8 text-lg text-blue-100">Join thousands who transformed their careers through M. Voc.</p>
...
export default function MvocPage() {
	return (
		<div className="min-h-screen bg-white text-slate-800">
			...
			<main>
				...
				<MvocProcess />
				<MvocEligibility />
				<ServiceEnquirySection serviceName="M.VOC" />
			</main>
			<Footer />
		</div>
	)
